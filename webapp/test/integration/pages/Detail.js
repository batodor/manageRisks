						...
						success : function (aEntitySet) {
							...
							return this.waitFor({
								...
								check: function (oList) {
									...
									var sObjectID = oList.getBindingContext().getProperty("Code");

									var iLength = aEntitySet.filter(function (oLineItem) {
										return oLineItem.Code === sObjectID;
									}).length;
					...
					return this.waitFor({
						...
						success : function (oList) {
							...
							return this.waitFor({
								id : "lineItemsHeader",
								viewName : sViewName,
								matchers : new PropertyStrictEquals({name: "text", value: "<ToComplianceRisksPlural> (" + iNumberOfItems + ")"}),
								success : function () {
