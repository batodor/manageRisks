sap.ui.define([
		...
		return BaseObject.extend("managerisks.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias managerisks.model.ListSelector
			 */
			 ...
			 * @return {managerisks.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
